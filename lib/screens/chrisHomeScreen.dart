// ignore_for_file: unused_field, deprecated_member_use, unnecessary_statements
...
class _HomeScreenState extends State<ChrisHomeScreen> {
  ...
  _onConfirmPressed() async {
    ...
    var userData = {'solo': soloride};
    await widget.db.updateCurrentUserModel(userData);
